...
class ConfigurationHelper(object):
    ...
    def validate_configuration(conn_info):
        if conn_info['client_id'] is None or conn_info['client_secret'] is None or conn_info['tenant_id'] is None:
          module.fail_json(msg='security token or client_id, client_secret and tenant_id is required')
...
class Capture(object):
    def __init__(self, 
        ...
        self._config = ComputeManagementClientConfiguration(credentials, subscription_id)
